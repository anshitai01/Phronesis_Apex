...
with col1:
    ...
    app1_html = f"""
    <a href="https://apex-responseanalyzer.streamlit.app/" target="_self" class="app-card-link" title="{APP1_DESC}">
        <div class="app-card">
...
with col2:
    # Use a structure that matches the CSS selectors (.app-card, .card-title, etc.)
    app2_html = f"""
    <a href="https://apex-themer.streamlit.app/" target="_self" class="app-card-link" title="{APP2_DESC}">
        <div class="app-card">
